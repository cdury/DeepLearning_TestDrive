...
learning_space = {
    "learning_rate": hp.qloguniform(
        "learning_rate", np.log(0.00001), np.log(1), 0.00001
    ),
    "lambda_loss_amount": hp.qloguniform(
        "lambda_loss_amount", np.log(0.00001), np.log(1), 0.00001
    ),
}
