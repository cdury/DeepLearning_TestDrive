...
class NNParameters(BaseParameters):
    ...
    def __init__(self, model_name, dir_path, loglevel, parent_name=None):
        ...
        self.dropout = 0
        self.layer_size_start = 1
        self.layer_size_decrease  = 2
...
class NNDefinition(BaseNN):
    ...
    def define_model(self, input_shape, output_shape) -> Model:
        ...
        size_of_layer = n_input * self.parameter.layer_size_start
        feed_layer = input_layer
        # create the layers and pass them the input tensor to get the output tensor:
        for layer_number in range(self.parameter.number_of_layers):
            hidden_layer = Dense(
                units=size_of_layer,
            ...
            size_of_layer = int(size_of_layer / self.parameter.layer_size_decrease)
            if size_of_layer < self.parameter.n_classes:
                break
