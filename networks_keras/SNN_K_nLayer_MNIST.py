...
class HyperParameters(BaseParameters):
    ...
    def __init__(self, model_name, loglevel):
        ...
        self.n_classes = 10  # Number of classification classes
        self.labels = LABELS
        # # Optimizer
...
class SNNLayerN(BaseNN):
    ...
    @timing
    def define_model(self, data_shape) -> Model:
        # Start defining the input tensor:
        dim = len(data_shape)
        if dim > 2:
            # ToDo: flatten
            pass
        n_input = data_shape[1]
    ...
    def setup_and_train_network(self):
        ...
        # END EITHER
            ...
            # Model
            # # Definition
            model = self.define_model(train_data[0].shape)
